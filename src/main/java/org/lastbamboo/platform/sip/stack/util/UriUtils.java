package org.lastbamboo.platform.sip.stack.util;
...
public interface UriUtils
     ...
     *
     * @param uriString
     *              The string containing a URI-formatting string.
     *
     * @return
     ...
     *      The port.
     * @param transport
     *      The transport to be used to connect.
     *
     * @return
     *      A URI for the given scheme, host, and port.
     */
     ...
     *
     * @return
     *      The user portion of the SIP URI as a Little Shoot person
     *      identifier..
     */
    int getPersonIdInSipUri
            (java.net.URI sipUri);
     ...
     * specified.
     */
    int getPortInSipUri(final URI uri);
